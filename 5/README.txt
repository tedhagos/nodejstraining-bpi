...
*Create the employees table* and insert some records

There is a SQL script named `nodetest.sql` in the src folder. You can use that to create the structure and populate the nodetest database.
